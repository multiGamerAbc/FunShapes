...
public class Square implements Shape{
    ...
    public Square(int xOrigin, int yOrigin, int myColorIndex, int referenceAngleScalar, 
    ...
    // Contains math to update coordinates for Square instance.
