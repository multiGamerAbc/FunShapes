...
public class FourPointStar implements Shape{
    ...
    public FourPointStar(int xOrigin, int yOrigin, int myColorIndex, int referenceAngleScalar, 
    ...
    // Contains math to update coordinates for FourPointStar instance.
