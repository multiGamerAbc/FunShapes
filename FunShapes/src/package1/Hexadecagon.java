...
public class Hexadecagon implements Shape{
    ...
    public Hexadecagon(int xOrigin, int yOrigin, int myColorIndex, int referenceAngleScalar, 
    ...
    // Contains math to update coordinates for Hexadecagon instance.
    public void updateCoords(){
    	...
    	xCoords[8] = xCurrent + sideLengthScalar * Math.sqrt(8) * Math.cos(
    	...
    	xCoords[10] = xCurrent + sideLengthScalar * Math.sqrt(8) * Math.cos(
    	...
    	xCoords[12] = xCurrent + sideLengthScalar * Math.sqrt(8) * Math.cos(
    	...
    	xCoords[14] = xCurrent + sideLengthScalar * Math.sqrt(8) * Math.cos(
    	...
    	yCoords[8] = yCurrent + sideLengthScalar * Math.sqrt(8) * Math.sin(
    	...
    	yCoords[10] = yCurrent + sideLengthScalar * Math.sqrt(8) * Math.sin(
    	...
    	yCoords[12] = yCurrent + sideLengthScalar * Math.sqrt(8) * Math.sin(
    	...
    	yCoords[14] = yCurrent + sideLengthScalar * Math.sqrt(8) * Math.sin(
